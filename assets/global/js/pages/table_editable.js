$(function () {
    ...
    function editableTable() {
        ...
        function editRow(oTable, nRow) {
            ...
            jqTds[6].innerHTML = '<div class="text-right"><a class="edit btn btn-sm btn-success" href="">Save123</a> <a class="delete btn btn-sm btn-danger" href=""><i class="icons-office-52"></i></a></div>';
        }
        ...
        function saveRow(oTable, nRow) {
            ...
            oTable.fnUpdate('<div class="text-right"><a class="edit btn btn-sm btn-default" href=""><i class="icon-note"></i></a> <a class="delete btn btn-sm btn-danger" href=""><i class="icons-office-52"></i></a></div>', nRow, 6, false);
            oTable.fnDraw();
        }
