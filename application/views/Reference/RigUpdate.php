  ...
  <body class="sidebar-top fixed-topbar fixed-sidebar theme-sdtl color-default dashboard">
    ...
    <!-- BEGIN PAGE CONTENT -->
        <div class="page-content">
          ...
          <form class="form-horizontal" method="post" action="<?php echo base_url().'Reference/Rig/Update/'.$id ?>">
          <div class="row">
                ...
                <div class="panel-content bg-default">
                    ...
                    <div class="form-group">
                          ...
                          <div class="col-sm-8">
                            ...
                            <option value="<?php echo $site->id ?>" <?php if($site->name == $table->site){echo "selected=true";} ?>><?php echo $site->name ?></option>
                            <?php endforeach; ?>
                    ...
                    <div class="form-group">
                          ...
                          <div class="col-sm-8">
                            ...
                            <option value="<?php echo $location->id ?>" class="<?php echo $location->siteRef ?>" <?php if($location->name == $table->location){echo "selected=true";} ?>><?php echo $location->name ?></option>
                            <?php endforeach; ?>
                       ...
                       <div class="form-group">
                          ...
                          <div class="col-sm-8">
                            <input autocomplete="off"  class="form-control" id="name" name="name" required type="text" placeholder="" value="<?php echo $table->rig ?>">
                          </div>
                        </div>
              ...
              <div class="panel">
                ...
                <div class="panel-content pagination2 table-responsive">
                  <table class="table table-hover table-dynamic">
                    ...
                    <tbody>
                    <?php foreach ($Tableall as $tableall):?>
                      <tr>
                     
                          
                                  <td><center> <div class="checkbox checkbox-danger">
                                                <input type="checkbox" name="msg[]" value="<?php echo $tableall->id; ?>">
                                   ...
                                   <?php if ($this->session->userdata('roleDrilling') == "Admin" || $this->session->userdata('Drilling')): ?>
                                    ...
                                    <center>
                                                                             ...
                                                                             <a class="btn btn-xs btn-success" href="<?php echo base_url().'Reference/Rig/pageUpdate/'.$tableall->id ?>" >
                        ...
                        <td><?php echo $tableall->site; ?></td>
                        <td><?php echo $tableall->location; ?></td>
                        <td><?php echo $tableall->name; ?></td>

                      </tr>
                     <div class="modal fade" id="<?php echo $tableall->id; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
