  ...
  <body class="sidebar-top fixed-topbar fixed-sidebar theme-sdtl color-default dashboard">
    ...
    <!-- BEGIN PAGE CONTENT -->
        <div class="page-content">
          <div class="header">
            <h2><strong>Input</strong> Area</h2>
          ...
          <form class="form-horizontal" method="post" action="<?php echo base_url().'Reference/Area/InputArea' ?>">
          <div class="row">
            <div class="col-lg-12 portlets">
              <div class="panel">
                <div class="panel-header panel-controls">
                  <h3><i class="icon-check"></i> <strong>AREA</strong> <small>information</small></h3>
                </div>
