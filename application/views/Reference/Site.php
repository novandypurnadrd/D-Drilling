  ...
  <body class="sidebar-top fixed-topbar fixed-sidebar theme-sdtl color-default dashboard">
    ...
    <!-- BEGIN PAGE CONTENT -->
        <div class="page-content">
          <div class="header">
            <h2><strong>Input</strong> SITE</h2>
          ...
          <form class="form-horizontal" method="post" action="<?php echo base_url().'Reference/Site/InputSite' ?>">
          <div class="row">
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-3">
                       <button type="submit" class="btn btn-embossed btn-primary m-r-20">Submit</button>
                        <button type="reset" class="cancel btn btn-embossed btn-default m-b-10 m-r-0" href="<?php echo base_url().'Reference/Site/' ?>">Cancel</button>
                      </div>
                    </div>
          ...
          <div class="row">
            <div class="col-lg-12 portlets">
              <div class="panel">
                <div class="panel-header panel-controls">
                  <h3><i class="icon-check"></i> <strong>TABLE</strong> <small>Site</small></h3>
                </div>
                <div class="panel-content bg-default">
                  <div class="row">

                    <form class="form-horizontal" role="form" action ="<?php echo base_url('Reference/Site/Delete_multiple'); ?>" method="post">
            <div class="col-lg-12 portlets">
              <div class="panel">
