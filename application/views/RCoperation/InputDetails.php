  ...
  <body class="sidebar-top fixed-topbar fixed-sidebar theme-sdtl color-default dashboard">
    ...
    <!-- BEGIN PAGE CONTENT -->
        <div class="page-content">
          <div class="header">
            <h2><strong>Input</strong> Reverse Circulation</h2>
            <div class="breadcrumb-wrapper">
              <ol class="breadcrumb">
                <li><a href="#">RC Operation</a>
                </li>
                <li class="active">RC Details</li>
              </ol>
            </div>
          </div>
          <form class="form-horizontal" method="post" action="<?php echo base_url().'RCoperation/InputDetails/InputRCDetails' ?>">
          ...
          <div class="row">
            <div class="col-lg-12 portlets">
              <div class="panel">
                <div class="panel-header panel-controls">
                  <h3><i class="icon-check"></i> <strong>RC</strong> <small>DETAIL</small></h3>
                </div>
                <div class="panel-content bg-default">
                    <div class="row">
                      <div class="col-md-3">
