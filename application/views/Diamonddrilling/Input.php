    ...
    <!-- BEGIN PAGE CONTENT -->
        <div class="page-content">
          ...
          <div class="row">
            ...
            <form class="form-horizontal" method="post" action="<?php echo base_url().'Diamonddrilling/Input/InputManpower' ?>">
          <div class="row">
            <div class="col-lg-12 portlets">
              <div class="panel">
                <div class="panel-header panel-controls">
                ...
                <div class="panel-content bg-default">
                    ...
                    <div class="row">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-8">
                        <input type="text" data-mask="99:99" class="form-control" placeholder="00:00" id="hoursfrom" name="hoursfrom">
                        </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-8">
                        <input type="text" data-mask="99:99" class="form-control" placeholder="00:00" id="hoursto" name="hoursto">
                        </div>
          ...
          <form class="form-horizontal" method="post" action="<?php echo base_url().'Diamonddrilling/Input/InputConsumable' ?>">
          <div class="row">
            <div class="col-lg-12 portlets">
              <div class="panel">
                <div class="panel-header panel-controls">
          ...
          <form class="form-horizontal" method="post" action="<?php echo base_url().'Diamonddrilling/Input/InputActivity' ?>">
          <div class="row">
            <div class="col-lg-12 portlets">
              <div class="panel">
                <div class="panel-header panel-controls">
          ...
          <form class="form-horizontal" method="post" action="<?php echo base_url().'Diamonddrilling/Input/InputDownhole' ?>">
            <div class="row">
            <div class="col-lg-12 portlets">
              <div class="panel">
                <div class="panel-header panel-controls">
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-sm-8">
                                <select class="form-control form-white" required id="description" name="description" onchange="SetValueDownhole()">
                                  <option value="Spearhead point">Spearhead point</option>
                                  <option value="Spiral pin">Spiral pin</option>
                                  <option value="Compression spring">Compression spring</option>
                                  <option value="Detent plunger">Detent plunger</option>
                                  <option value="Spearhead base">Spearhead base</option>
                                  <option value="Spring pin">Spring pin</option>
                                  <option value="Latch retract case">Latch retract case</option>
                                  <option value="Latch spring">Latch spring</option>
                                  <option value="Latch">Latch</option>
                                  <option value="Latch support">Latch support</option>
                                  <option value="Upper latch body">Upper latch body</option>
                                  <option value="Landing shoulder ring">Landing shoulder ring</option>
                                  <option value="Lower latch body">Lower latch body</option>
                                  <option value="Lock nut">Lock nut</option>
                                  <option value="Spindle Assy">Spindle Assy</option>
                                  <option value="Shut off valve soft">Shut off valve soft</option>
                                  <option value="Shut off valve hard">Shut off valve hard</option>
                                  <option value="Valve adjusting washer">Valve adjusting washer</option>
                                  <option value="Ball thrust bearing">Ball thrust bearing</option>
                                  <option value="Spindle bearing">Spindle bearing</option>

                                  <option value="Hanger bearing">Hanger bearing</option>
                                  <option value="Self lock nut">Self lock nut</option>
                                  <option value="Inner tube cap">Inner tube cap</option>
                                  <option value="Grease fitting">Grease fitting</option>
                                  <option value="Stainless steel ball">Stainless steel ball</option>
                                  <option value="Check valve body">Check valve body</option>
                                  <option value="O ring">O ring</option>
                                  <option value="Piston">Piston</option>
                                  <option value="Splith">Splith</option>
                                  <option value="Inner tube">Inner tube</option>
                                  <option value="Stop ring">Stop ring</option>
                                  <option value="Core lifter">Core lifter</option>
                                  <option value="Core case">Core case</option>
                                  <option value="Locking coupling">Locking coupling</option>
                                  <option value="Adaptor coupling">Adaptor coupling</option>
                                  <option value="Landing ring">Landing ring</option>
                                  <option value="Outer tube">Outer tube</option>
                                  <option value="Inner tube stabilizer">Inner tube stabilizer</option>
                                  <option value="Thread protector">Thread protector</option>
                    ...
                    <div class="form-group">
                     ...
                     <div class="col-md-3">
                       <div class="form-group">
                          ...
                          <div class="col-sm-8">
                            <input autocomplete="off"  class="form-control" id="series" name="series" type="text" placeholder="">
                          </div>
                        </div>
            ...
            <form class="form-horizontal" method="post" action="<?php echo base_url().'Diamonddrilling/Input/InputSurvey' ?>">
            <div class="row">
            <div class="col-lg-12 portlets">
              <div class="panel">
                <div class="panel-header panel-controls">
