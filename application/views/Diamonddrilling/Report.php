  ...
  <body class="sidebar-top fixed-topbar fixed-sidebar theme-sdtl color-default dashboard">
    ...
    <!-- BEGIN PAGE CONTENT -->
        <div class="page-content">
          <div class="header">
            <h2><strong>Report</strong> Diamond Drilling</h2>
         ...
         <form class="form-horizontal" method="post" action="<?php echo base_url().'Diamonddrilling/Report/ViewReport' ?>">
          <div class="row">
            ...
            <form class="form-horizontal" method="post" action="<?php echo base_url().'Diamonddrilling/Report/Delete_multiple_Manpower' ?>">
           <div class="row">
            <div class="col-lg-12 portlets">
              <div class="panel">
                <div class="panel-header panel-controls">
           ...
           <form class="form-horizontal" method="post" action="<?php echo base_url().'Diamonddrilling/Report/Delete_multiple_Consumable' ?>">
           <div class="row">
            <div class="col-lg-12 portlets">
              <div class="panel">
                <div class="panel-header panel-controls">
          ...
          <form class="form-horizontal" method="post" action="<?php echo base_url().'Diamonddrilling/Report/Delete_multiple_Activity' ?>">
           <div class="row">
            <div class="col-lg-12 portlets">
              <div class="panel">
                <div class="panel-header panel-controls">
           ...
           <form class="form-horizontal" method="post" action="<?php echo base_url().'Diamonddrilling/Report/Delete_multiple_Downhole' ?>">
           <div class="row">
            <div class="col-lg-12 portlets">
              <div class="panel">
                <div class="panel-header panel-controls">
          ...
          <form class="form-horizontal" method="post" action="<?php echo base_url().'Diamonddrilling/Report/Delete_multiple_Survey' ?>">
           <div class="row">
            <div class="col-lg-12 portlets">
              <div class="panel">
                <div class="panel-header panel-controls">
                  <h3><i class="fa fa-table"></i> <strong> Survey</strong> table</h3>
                </div>
                <div class="panel-content pagination2 table-responsive">
                  <table class="table table-hover table-dynamic">
                    <thead>
                    ...
                    <tbody>
                      <?php foreach ($Survey as $survey){?> 
                                       ...
                                       <tr>
                                         <td><center> <div class="checkbox checkbox-danger">
                                                <input type="checkbox" id="checkAll" name="msg[]" value="<?php echo $survey->id; ?>">
                                                <label></label><center> </td>
                                      <!--  <?php //if ($this->session->userdata('roleDrilling') == "Admin" || $this->session->userdata('Drilling')): ?>
                                    <td class="center">
                                    <center>
                                    
                                                                             <a class="btn btn-xs btn-success" href="<?php //echo base_url().'Assay/Update/pageUpdate/'.$survey->id ?>" >
                                                                            <span class="fa fa-pencil"></span>
                                       </a>
                                    </center>
                                  </td> 
                                            ...
                                            <td><?php echo $survey->hole; ?></td>
                                            <td><?php echo $survey->depth; ?></td>
                                            <td><?php echo $survey->dip; ?></td>
                                            <td><?php echo $survey->azimuth; ?></td>
          ...
          <div class="col-sm-6">
                                                    ...
                                                    <button type="sumbit" class="btn btn-danger btn-bordered" onclick="SetValueSurvey()"><i class=" mdi mdi-delete"></i>Delete Survey</button>
               ...
               <div class="col-md-1">
                       <div class="form-group">
                          <label class="col-sm-4 control-label"></label>
                          <div class="col-sm-8">
                            <input autocomplete="off" type="hidden" class="form-control" id="dateSurveyStart" name="dateSurveyStart" type="text" placeholder="">
                          </div>
                        </div> 
                      </div>
                      <div class="col-md-1">
                       <div class="form-group">
                          <label class="col-sm-4 control-label"></label>
                          <div class="col-sm-8">
                            <input autocomplete="off" type="hidden" class="form-control" id="dateSurveyEnd" name="dateSurveyEnd" type="text" placeholder="">
                          </div>
                        </div> 
                      </div>
                        <div class="col-md-1">
           ...
           <form class="form-horizontal" method="post" action="<?php echo base_url().'Diamonddrilling/Report/Delete_multiple_Details' ?>">
           <div class="row">
            <div class="col-lg-12 portlets">
              <div class="panel">
                <div class="panel-header panel-controls">
